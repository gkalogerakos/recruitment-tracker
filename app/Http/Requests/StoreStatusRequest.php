...
class StoreStatusRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'step_id' => [
                'required',
                'integer',
                'exists:steps,id', // Check if the step_category_id exists
                Rule::exists('steps', 'id')->where('timeline_id', $this->timeline_id),
            ],
            'status_category_id' => [
                'required',
                'integer',
    ...
    public function messages(): array
    {
        return [
            ...
            'step_id.required' => 'Step category is required.',
            'step_id.integer' => 'Step category id must be an integer.',
            'step_id.exists' => 'The selected step does not belong to the given timeline or does not exist.',
